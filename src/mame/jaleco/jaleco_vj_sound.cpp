...
void jaleco_vj_isa16_sound_device::device_start()
{
    ...
    // TODO: Split this out into a device specific to Stepping Stage
...
{
    map(0x000000, 0xffffff).ram().share("ymz_ram2");
}
