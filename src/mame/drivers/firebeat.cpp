...
static INPUT_PORTS_START(bm3)
	...
	PORT_BIT( 0x03ff, 0x00, IPT_TRACKBALL_X) PORT_PLAYER(1) PORT_NAME("Turntable") PORT_MINMAX(0x00,0x3ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(10)

	PORT_START("TURNTABLE_P2")
	PORT_BIT( 0x03ff, 0x00, IPT_TRACKBALL_X) PORT_PLAYER(2) PORT_NAME("Turntable") PORT_MINMAX(0x00,0x3ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(10)
...
ROM_START( popn6 )
	...
	ROM_REGION(0xc0, "user2", ROMREGION_ERASE00)    // Security dongle
	ROM_LOAD( "gqa16-ja", 0x000000, 0x0000c0, BAD_DUMP CRC(f2094180) SHA1(36559307f73fe4d9e21533041e8ff8f9297773ed) )
...
ROM_START( popn7 )
	...
	ROM_REGION(0xc0, "user2", ROMREGION_ERASE00)    // Security dongle
	ROM_LOAD("gcb00-ja", 0x00, 0xc0, CRC(45223b93) SHA1(b05a260ddc3dbedc3209509b9848d2ccf2319584))
...
ROM_START( popn8 )
	...
	ROM_REGION(0xc0, "user2", ROMREGION_ERASE00)    // Security dongle
	ROM_LOAD( "gqb30-ja", 0x000000, 0x0000c0, CRC(a2276ca5) SHA1(eff519ef21befa5f843f84f3b81d3397a173fe99) )
...
ROM_START( popnmt )
	...
	ROM_REGION(0xc0, "user2", ROMREGION_ERASE00)    // Security dongle
	ROM_LOAD("gq976-ja.bin", 0x00, 0xc0, CRC(673c2478) SHA1(97e7952a503a93f5334faf1882e8b0394148cf84) )
...
GAME(  2000, bm3,      0,      firebeat_spu_bm3, bm3,  firebeat_state, init_popn,ROT0,   "Konami",  "Beatmania III", MACHINE_NOT_WORKING)
GAME(  2000, bm3core,  0,      firebeat_spu_bm3, bm3,  firebeat_state, init_popn,ROT0,   "Konami",  "Beatmania III Append Core Remix", MACHINE_NOT_WORKING)
GAME(  2001, bm36th,   0,      firebeat_spu_bm3, bm3,  firebeat_state, init_popn,ROT0,   "Konami",  "Beatmania III Append 6th Mix", MACHINE_NOT_WORKING)
GAME(  2002, bm37th,   0,      firebeat_spu_bm3, bm3,  firebeat_state, init_popn,ROT0,   "Konami",  "Beatmania III Append 7th Mix", MACHINE_NOT_WORKING)
GAME(  2003, bm3final, 0,      firebeat_spu_bm3, bm3,  firebeat_state, init_popn,ROT0,   "Konami",  "Beatmania III The Final", MACHINE_NOT_WORKING)
